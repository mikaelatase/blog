      ...
      <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
        <div className="md:w-1/2 px-8 md:px-16">
          ...
          <form action="" className="flex flex-col gap-4">
            ...
            <button className="bg-purple-800 rounded-xl text-white py-2 hover:scale-105 duration-300">Login</button>
          </form>
          ...
          <div className="mt-5 text-xs border-b border-purple-800 py-4 text-purple-800">
