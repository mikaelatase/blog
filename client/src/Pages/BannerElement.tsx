  ...
  return (
    <div className="block md:flex md:space-x-2 px-2 lg:p-0">
        ...
        >
          ...
          <img src= {props.bannerImage} className="absolute left-0 top-0 w-full h-full rounded z-0 object-cover" />
          <div className="p-4 absolute bottom-0 left-0 z-20">
            ...
            <div className="flex mt-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-400 text-xs"> {props.bannerDateOfCreation} </p>
              </div>
            </div>
          </div>
        </a>
